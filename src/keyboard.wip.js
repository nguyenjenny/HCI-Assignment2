...
class KeyboardZoom extends KeyboardNormal {
  ...
  onPointerUp(e) {
    ...
    e.stopPropagation();
    console.log(
      "[PointerUp] xy - " + e.nativeEvent.offsetX + "/" + e.nativeEvent.offsetY
    );
    this.onKeyClick(e);
    //e.preventDefault();
    //e.stopPropagation();
  ...
  onMouseDown(e) {
    console.log(
      "[MouseDown] xy - " + e.nativeEvent.offsetX + "/" + e.nativeEvent.offsetY
    );
    this.onKeyClick(e);
    e.preventDefault();
    e.stopPropagation();
  ...
  doZoom = (x, y, scaleFactor, currentZoomVal, maxZoom, centerBias) => {
    ...
    console.log(
      "[Debug] scaleFactor/ CurrnetZoomVal / maxZoom -> " +
        scaleFactor +
        "/ " +
        currentZoomVal +
        "/ " +
    ...
    if (this.isZoomed) {
      ...
      var biasedViewportX =
        x - (newViewportWidth * (x - this.viewport.x)) / this.viewport.width;
      var biasedViewportY =
        y - (newViewportHeight * (y - this.viewport.y)) / this.viewport.height;
